...
public class AppController {
	...
	public Optional<Student> searchStudentById(@RequestParam Optional<Long> id, @RequestParam Optional<String> name){
		if(!name.isEmpty()) {
			return Optional.of(userDAO.searchStudentByName(name));
		} else {
			return Optional.of(userDAO.searchStudentById(id));
		}
	}
}
